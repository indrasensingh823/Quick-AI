      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 relative">
        ...
        <div className="flex items-center justify-between">
          ...
          {content && (
            <button
              ...
              className="flex items-center gap-1 text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-md hover:bg-blue-100 transition"
            >
        ...
        {!content ? (
          ...
          <img
            src={content}
            alt="processed"
            className="mt-3 w-full h-full object-contain rounded-lg"
          />
        )}
      </div>
    </div>
